...
// ── Shell helper (matches existing Loki shell style) ─────────────────────────
...
.data-table tbody tr:hover{background:#fafaf8;cursor:pointer}
...
.inline-form input,.inline-form select{padding:8px 12px;border:1px solid #ddd;border-radius:8px;font-size:13px;background:#fff;font-family:inherit;color:#1a1a1a}
.inline-form input:focus,.inline-form select:focus{outline:none;border-color:#888}
...
.divider{height:1px;background:#f0efe9;margin:1.25rem 0}
