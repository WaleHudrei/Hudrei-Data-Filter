...
function openRemoveFromListModal() {
  ...
  var msg = _allSelected
    ? 'Remove <strong>all ' + count.toLocaleString() + ' selected properties</strong> from this list? The properties themselves remain in Oculah; only their link to this list is removed.'
    : 'Remove <strong>' + count + ' propert' + (count===1?'y':'ies') + '</strong> from this list? The propert' + (count===1?'y remains':'ies remain') + ' in Oculah; only the link to this list is removed.';
